...
async function createCommandModule(
  ...
  let name = commandName(item, parentItem);
...
export const builder = (yargs: Argv) => yargs.commandDir('${name}').version(false);
 ...
 */
function markdownTable(head: string[], body: any[][]): string {
